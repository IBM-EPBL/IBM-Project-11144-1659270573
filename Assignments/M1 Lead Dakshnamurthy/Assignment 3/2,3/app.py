...
COS_API_KEY_ID = "CS9-Q9e5naGaMt488-6BW_F5CfE7M2WcQ6B789YwacSk"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/89f6ec88dece48e8b2156880bea3761c:889d59f2-33a3-4fc3-873f-2a88a79f3225::"
...
@app.route('/')
def index():
    file1 = get_bucket_contents('bucket-dakshnamurthy')
